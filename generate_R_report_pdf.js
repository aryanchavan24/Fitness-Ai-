...
try {
  ...
  const mdContent = fs.readFileSync('R_Programming_Concepts_FitTrack_AI.md', 'utf8');
  ...
  <head>
    <meta charset="utf-8">
    <title>FitTrack AI - R Programming Concepts</title>
    <style>
      body {
  ...
  fs.writeFileSync('r_report_temp.html', fullHtml);
  ...
  const pdfPath = __dirname + '\\R_Programming_Concepts_FitTrack_AI.pdf';
  const htmlPath = 'file:///' + __dirname.replace(/\\/g, '/') + '/r_report_temp.html';
